...
# A state can be represented by ((CurrentX, CurrentY), {Blizzards}, time)
# Blizzards is a dict in the form (X, Y) -> (Direction, X, Y)
...
answer = shortestTime(((1, 0), 0), (width, height + 1))
